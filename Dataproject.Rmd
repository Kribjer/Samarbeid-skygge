...
At first glance, we can see that the top 5 countries either has a fairly large population or a well developed economy. What we also found interesting is China being at the top, as it is also on the top of global total Co2 emissions. 

# HUSK FORKLARE RUNDT NOEN AV LANDENE EKS: USA
Now try to search for United states. As you can see from the graph there are three major dips in 1977. This may have been caused by the 1973 energy crisis. The reason is that due to this crisis the united stated decided to be energy independent and consolidated the federal energy administration which also had a energy research and development administration. All this may have led to make it more difficult to research and develop sources of renewable energy. In the 1980 US daman for oil started to increase, at the same time the situation in the Gulf forced US to protect their oil tankers.   Then we have 2001. Since its mainly hydro that produces renewable energy in the US makes it vulnerable to drought, which happened in 2001.  
...
We looked into the sources from where the countries with high consumption of renewable energy got there energy from. All the countries got mainly their energy from hydro-alternatives, wind was second most common followed by solar. 
And then we found something really surprising when we looked at the countries with high growth rate. We initially thought the countries also mainly would use hydro as their energy source, but it turned out that the these countries get there renewable energy from wind and solar.

After a little more research  we found out that developing countries have poor access to formal finance witch makes it difficult to start big projects. This leads to difficulties when investors want to invest because there is a lack of investor protection. Bad social infrastructure and political instability can affect the investment poorly. 
